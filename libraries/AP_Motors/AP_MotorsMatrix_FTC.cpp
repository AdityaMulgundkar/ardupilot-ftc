...
bool AP_MotorsMatrix_FTC::init(uint8_t expected_num_motors)
{
...
bool AP_MotorsMatrix_FTC::set_throttle_factor(int8_t motor_num, float throttle_factor)
{
    if ((_active_frame_class != MOTOR_FRAME_SCRIPTING_MATRIX) ) {
        // not the correct class
        return false;
...
void AP_MotorsMatrix_FTC::set_update_rate(uint16_t speed_hz)
{
...
void AP_MotorsMatrix_FTC::set_frame_class_and_type(motor_frame_class frame_class, motor_frame_type frame_type)
{
...
uint32_t AP_MotorsMatrix_FTC::get_motor_mask()
{
...
void AP_MotorsMatrix_FTC::_output_test_seq(uint8_t motor_seq, int16_t pwm)
{
...
//  pwm value is an actual pwm value that will be output, normally in the range of 1000 ~ 2000
bool AP_MotorsMatrix_FTC::output_test_num(uint8_t output_channel, int16_t pwm)
{
    if (!armed()) {
        return false;
    }
        ...
        case MOTOR_FRAME_QUAD:
            ...
            switch (frame_type) {
                ...
                case MOTOR_FRAME_TYPE_Y4:
                    ...
                    static const AP_MotorsMatrix_FTC::MotorDefRaw motors[] {
...
*/
void AP_MotorsMatrix_FTC::thrust_compensation(void)
{
...
*/
void AP_MotorsMatrix_FTC::disable_yaw_torque(void)
{
    for (uint8_t i = 0; i < AP_MOTORS_MAX_NUM_MOTORS; i++) {
        _yaw_factor[i] = 0;
    }
